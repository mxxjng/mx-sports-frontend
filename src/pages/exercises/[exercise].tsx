...
export default function Exercise() {
    ...
    const [allExerciseDataOpen, setAllExerciseDataOpen] = useState(false);
    const [allOneRepMaxOpen, setAllOneRepMaxOpen] = useState(false);
                        ...
                        <div>
                            ...
                            {data ? (
                                <div>
                                    ...
                                    />
                                    <ExerciseDataModal
                                        isOpen={allExerciseDataOpen}
                                        close={() =>
                                            setAllExerciseDataOpen(false)
                                        }
                                    ...
                                    />
                                    <OneRepMaxModal
                                        isOpen={allOneRepMaxOpen}
                                        close={() => setAllOneRepMaxOpen(false)}
                                        data={data?.oneRepMax}
                                        setCurrentTraining={(id) =>
                                            setCurrentTraining(id)
                                        }
